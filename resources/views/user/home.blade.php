                                    ...
                                    <tbody>
                                        @if ($user->admission->isEmpty())
                                            <tr class="text-center">
                                                <td colspan="4">You have Not Applied in any Program</td>
                                            </tr>
                                        @else
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            @elseif ($applied_program->admissionFee != null && $applied_program->admissionFee->count() > 0)
                                                                <div class="col-3">
                                                                    <a href="{{ route('user.review-application', $applied_program->id) }}"
                                                                        class="btn btn-warning btn-sm">Review&Submit</a>
                                                                </div>
                                                            @else
                                                                <div class="col-3">
                                                                    <a href="{{ route('user.pay-admission-fee.show', $applied_program->id) }}"
