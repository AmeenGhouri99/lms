                        ...
                        <div class="row pt-1 pb-1">
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control dt-full-name" id="basic-icon-default-fullname"
                                    placeholder="John" name="user-fullname" />
                            </div>
                            <div class="col-4">
                                ...
                                <input type="text" id="basic-icon-default-uname" class="form-control dt-uname"
                                    placeholder="Doe" name="user-name" />
                            </div>
                            <div class="col-4">
                        ...
                        <div class="row pt-1 pb-1">
                            <div class="col-4">
                                ...
                                <input type="text" id="basic-icon-default-contact" class="form-control dt-contact"
                                    placeholder="+1 (111) 222-33-44" name="user-contact" />
                            </div>
                            <div class="col-4">
                                ...
                                <input type="text" id="basic-icon-default-company" class="form-control dt-contact"
                                    placeholder="A1B2C3" name="user-company" />
                            </div>
                            <div class="col-4">
                                <label class="form-label" for="password">Password</label>
                                <input type="password" id="password" class="form-control dt-contact" placeholder="********"
                                    name="user-contact" />
                            </div>
                        </div>
